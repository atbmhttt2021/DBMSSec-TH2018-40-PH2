...
--Compartment
EXEC sa_components.create_compartment(policy_name => 'THONGBAO_ols_pol',comp_num => 5, short_name => 'OTH', long_name => 'NHAN VIEN KHAC');
...
EXEC sa_components.create_compartment(policy_name => 'THONGBAO_ols_pol',comp_num => 60, short_name => 'QLCM', long_name => 'PHONG QUAN LY CHUYEN MON');
EXEC sa_components.create_compartment(policy_name => 'THONGBAO_ols_pol',comp_num => 70, short_name => 'QLTV', long_name => 'PHONG QUAN LY TAI VU');
EXEC sa_components.create_compartment(policy_name => 'THONGBAO_ols_pol',comp_num => 80, short_name => 'QLTN', long_name => 'PHONG QUAN LY TAI NGUYEN');
...
BEGIN
  ...
  CASE ID_DONVI
    ...
    else i_label := i_label || 'OTH:';
  END CASE;
  CASE ID_CHINHANH
	  WHEN 'BV001' THEN i_label := i_label || 'DKTD';
...
table_name => 'THONGBAO',
table_options => 'insert_control,update_control',
