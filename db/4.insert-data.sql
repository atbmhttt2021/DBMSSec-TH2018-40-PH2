  ...
  insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI, CHINHANH, GIOITINH)
  values ('Ly Van An','',TO_DATE('12/04/1966', 'DD/MM/YYYY'),'7 Ly Thai To, TP HCM','NVKT01',8,'BV001','male'); --
  insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI, CHINHANH, GIOITINH)
  values ('Ly Van An','',TO_DATE('12/04/1966', 'DD/MM/YYYY'),'7 Ly Thai To, TP HCM','NVKT02',8,'BV001','male');  10
  ...
  insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI, CHINHANH, GIOITINH)
  values ('Ly Van An','',TO_DATE('12/04/1966', 'DD/MM/YYYY'),'7 Ly Thai To, TP HCM','NVKT04',8,'BV002','male'); 
