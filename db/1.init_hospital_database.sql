...
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Kim Khanh','',TO_DATE('12/01/1960', 'DD/MM/YYYY'),'174 Nguyen Van Banh, TP HCM','NVQLTN01',2,'male'); -- 1
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Ly Thi Hien','',TO_DATE('12/01/1989', 'DD/MM/YYYY'),'68 Kha Van Can, Tp HCM','NVQLTV01',3,'female'); -- 2
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Minh Trang','',TO_DATE('12/06/1985', 'DD/MM/YYYY'),'15 Ton Duc Thang, tp HCM','NVQLCM01',4,'female'); -- 3
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Quynh Nhu','',TO_DATE('12/03/1960', 'DD/MM/YYYY'),'24/2 Tran Khac Tran,TP HCM','NVTT01',5,'female'); -- 4
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Anh Minh','',TO_DATE('14/01/1960', 'DD/MM/YYYY'),'72 Phan Dinh Giot, TP HCM','NVBT01',7,'male'); -- 5
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Ly Ngoc Binh','',TO_DATE('12/03/1976', 'DD/MM/YYYY'),'107 Hoa Hung,TP HCM','BS01',9,'male'); -- 6
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Tran Van Quyet','',TO_DATE('19/06/1968', 'DD/MM/YYYY'),'80 Ly Chinh Thang, TP HCM','BS02',9,'male'); -- 7
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Ngoc Hoa','',TO_DATE('03/12/1968', 'DD/MM/YYYY'),'77 Ly Chinh Thang, TP HCM','NVTV01',6,'female'); -- 8
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Kim Uyen','',TO_DATE('24/06/1971', 'DD/MM/YYYY'),'99 Phung Khac Khoan, TP HCM','NVKT01',8,'female'); -- 9
insert into NHANVIEN (TENNV, LUONGCA, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('Ly Van An','',TO_DATE('12/04/1966', 'DD/MM/YYYY'),'7 Ly Thai To, TP HCM','NHANVIEN_KETOAN',8,'male'); -- 10
