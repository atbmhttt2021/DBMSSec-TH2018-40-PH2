-- Connect to user: SYSTEM  via an oracle client like sqldeveloper or
-- sqlplus:  connect SYSTEM/ORACLE
-- (if not create tables with SYSTEM, edit schema /src/utils/config.js to another user)
...
insert into DONVI (TENDV) values ('Admin'); -- 1
insert into DONVI (TENDV) values ('Phòng quản lý tài nguyên'); -- 2
insert into DONVI (TENDV) values ('Phòng quản lý tài vụ'); -- 3
insert into DONVI (TENDV) values ('Phòng quản lý chuyên môn'); -- 4
insert into DONVI (TENDV) values ('Phòng tiếp tân và điều phối'); -- 5
insert into DONVI (TENDV) values ('Phòng tài vụ'); -- 6
insert into DONVI (TENDV) values ('Phòng bán thuốc'); -- 7
insert into DONVI (TENDV) values ('Phòng kế toán'); -- 8
insert into DONVI (TENDV) values ('Khoa tai mũi họng'); -- 9
insert into DONVI (TENDV) values ('Khoa răng hàm mặt'); -- 10
insert into DONVI (TENDV) values ('Khoa mắt'); -- 11
insert into DONVI (TENDV) values ('Khoa huyết học truyền máu'); -- 12
insert into DONVI (TENDV) values ('Khoa nội hô hấp - tiêu hóa'); -- 13
insert into DONVI (TENDV) values ('Khoa chấn thương chỉnh hình'); -- 14
insert into DONVI (TENDV) values ('Khoa ngoại thần kinh'); -- 15
insert into DONVI (TENDV) values ('Khoa y học cổ truyền'); --16
insert into DONVI (TENDV) values ('Khoa sản'); -- 17
insert into DONVI (TENDV) values ('Khoa chẩn đoán hình ảnh'); -- 18
insert into DONVI (TENDV) values ('Khoa xét nghiệm'); -- 19


--insert NHANVIEN

insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Kim Khanh','6912000',TO_DATE('12/01/1960', 'DD/MM/YYYY'),'174 Nguyen Van Banh, TP HCM','NHANVIEN_QUANLY_TAINGUYEN_NHANSU',2,'male'); -- 1
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Ly Thi Hien','6912000',TO_DATE('12/01/1989', 'DD/MM/YYYY'),'68 Kha Van Can, Tp HCM','NHANVIEN_QUANLY_TAIVU',3,'female'); -- 2
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Minh Trang','6912000',TO_DATE('12/06/1985', 'DD/MM/YYYY'),'15 Ton Duc Thang, tp HCM','NHANVIEN_QUANLY_CHUYENMON',4,'female'); -- 3
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Quynh Nhu','6912000',TO_DATE('12/03/1960', 'DD/MM/YYYY'),'24/2 Tran Khac Tran,TP HCM','NHANVIEN_LETAN',5,'female'); -- 4
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Anh Minh','6912000',TO_DATE('14/01/1960', 'DD/MM/YYYY'),'72 Phan Dinh Giot, TP HCM','NHANVIEN_BANTHUOC',7,'male'); -- 5
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Ly Ngoc Binh','12800000',TO_DATE('12/03/1976', 'DD/MM/YYYY'),'107 Hoa Hung,TP HCM','BACSI_KHOANGOAI',15,'male'); -- 6
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Tran Van Quyet','6912000',TO_DATE('19/06/1968', 'DD/MM/YYYY'),'80 Ly Chinh Thang, TP HCM','BACSI_KHOANOI',13,'male'); -- 7
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Nguyen Ngoc Hoa','6912000',TO_DATE('03/12/1968', 'DD/MM/YYYY'),'77 Ly Chinh Thang, TP HCM','NHANVIEN_TAIVU',6,'female'); -- 8
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH) 
values ('Phan Kim Uyen','6912000',TO_DATE('24/06/1971', 'DD/MM/YYYY'),'99 Phung Khac Khoan, TP HCM','NHANVIEN_KETOAN',8,'female'); -- 9
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('Ly Van An','6912000',TO_DATE('12/04/1966', 'DD/MM/YYYY'),'7 Ly Thai To, TP HCM','NHANVIEN_KETOAN',8,'male'); -- 10

-- NHAN VIEN TEMP
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('Nguyen Van A','6912000',TO_DATE('12/01/1970', 'DD/MM/YYYY'),'HO CHI MINH','NHANVIEN_TEMP',1,'male'); -- 11
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('Le Thi B','69120020',TO_DATE('12/01/1990', 'DD/MM/YYYY'),'HO CHI MINH','NHANVIEN_TEMP',1,'male'); -- 12
-- NHAN VIEN ADMIN
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('DUCCAO_ADMIN','6912000',TO_DATE('12/01/1960', 'DD/MM/YYYY'),'HO CHI MINH','NHANVIEN_ADMIN',1,''); -- 13
insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('THAOTRUONG','6912000',TO_DATE('12/01/1960', 'DD/MM/YYYY'),'HO CHI MINH','NHANVIEN_ADMIN',1,'female'); -- 14

insert into NHANVIEN (TENNV, LUONG, NGAYSINH, DIACHI, VAITRO, DONVI,GIOITINH)
values ('SYSTEM ADMIN','6912000',TO_DATE('12/01/1960', 'DD/MM/YYYY'),'HO CHI MINH','SYSTEM',1,'female'); -- 14
...
--insert don thuoc
insert into DONTHUOC (ID_KHAMBENH,NVPT)
values (1,5); -- 1
insert into DONTHUOC (ID_KHAMBENH,NVPT)
values (2,5); -- 2
insert into DONTHUOC (ID_KHAMBENH,NVPT)
